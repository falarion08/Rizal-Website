function Card(props){
    ...
    return (
        <>
            <div className="border-2 border-black w-96 rounded-xl shadow-2xl bg-[#f7f1e8]">
                ...
                <div className=" text-center p-2 ">
                    <button onClick={selectContent} className={"py-2 px-12 rounded border-2 border-black bg-[#642B62] text-white font-bold "  + props.hidden}>Magbasa pa</button>
                </div>
            </div>
        </>
    )
